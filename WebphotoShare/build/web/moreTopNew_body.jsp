...
List<TblImage> ilist=iremote.topNewPaging(range);
%>
<body>
			 <!--Primary//////////////////////////////////////////////////////////////////////////////////////-->
			 	<div class="primary">
                        <div class="primary-2">
                        		<div class="photo-primary-2-left">
                                            <p class="p-tis-topvote" id="photo-tis"><a href="homepage.jsp"><span class="h1">P</span>hotoshare  </a>>> <a href="#">Top new Image Upload</a></p>
                                                        <%
                                ...
                                <div class="photo-page">
                                    ...
                                    for(int i=0;i<totalpage;i++)
                                        {
                                    %>
                                    <a href="moreTopNew.jsp?pages=<%= i+1%>"><%= i+1%></a>
                                        <%
                                        }
                                    %>
                                    <a href="#">></a>
