...
total=iremote.countImageByName(name);
totalpage=(total/7)+1;
range[0]=7*(pages-1);
range[1]=7*(pages);//9;
if(range[1]>total)range[1]=total;
List<TblImage> ilist=iremote.searchImageByname(name, range);
%>
<body>
			 <!--Primary//////////////////////////////////////////////////////////////////////////////////////-->
			 	<div class="primary">
                        <div class="primary-2">
                        		<div class="photo-primary-2-left">
                                            <p class="p-tis-topvote" id="photo-tis"><a href="homepage.jsp"><span class="h1">P</span>hotoshare  </a>>> <a href="#">Search Result </a></p>
                                                        <%
                                ...
                                <div class="photo-page">
                                    ...
                                    for(int i=0;i<totalpage;i++)
                                        {
                                    %>
                                    <a href="search.jsp?pages=<%= i+1%>&keyword=<%= name %>"><%= i+1%></a>
                                        <%
                                        }
                                    %>
                                    <a href="#">></a>
